...
public class TestAutomation extends App {
    ...
    @Test
    @Order(8)
    public void test_check_apply_coupon_button() throws IOException {
        boolean testcase_status = true;
        try {
            boolean check_apply_coupon_button_succeed = Activities.check_apply_coupon_button(driver);
           // System.out.println("click_item_detail_menu_succeed " + click_item_detail_menu_succeed);
            if (!check_apply_coupon_button_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    @Test
    @Order(10)
    public void test_check_if_remove_option_available() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean check_if_remove_option_available_succeed = Activities.check_if_remove_option_available(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!check_if_remove_option_available_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    @Test
    @Order(11)
    public void test_remove_product() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean remove_product_succeed = Activities.remove_product(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!remove_product_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    @Test
    @Order(12)
    public void test_check_message_after_removal_of_item() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean check_message_after_removal_of_item_succeed = Activities.check_message_after_removal_of_item(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!check_message_after_removal_of_item_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    @Test
    @Order(13)
    public void test_update_quantity() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean update_quantity_succeed = Activities.update_quantity(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!update_quantity_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    @Test
    @Order(14)
    public void test_check_if_update_basket_button_available() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean check_if_update_basket_button_available_succeed = Activities.check_if_update_basket_button_available(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!check_if_update_basket_button_available_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    public void test_check_checkout_button() throws IOException {
        ...
        boolean testcase_status = true;
        try {
            boolean check_product_total_checkout_page_succeed = Activities.check_checkout_button(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
    ...
    @Test
    @Order(16)
    public void test_click_checkout_button() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean click_checkout_button_succeed = Activities.click_checkout_button(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!click_checkout_button_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
    ...
    @Test
    @Order(17)
    public void test_check_navigation_to_billing_details_page() throws IOException {
        
        boolean testcase_status = true;
        try {
            boolean check_navigation_to_billing_details_page_succeed = Activities.check_navigation_to_billing_details_page(driver);
            //System.out.println("check_product_total_checkout_page_succeed " + check_product_total_checkout_page_succeed);
            if (!check_navigation_to_billing_details_page_succeed) {
                testcase_status = false;
            }
            System.out.println("testcase_status " + testcase_status);
            yakshaAssert(currentTest(), testcase_status, businessTestFile);
